  ...
  return (
    <section className={cn("space-y-3", className)}>
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <h2 className="text-[14px] font-black text-[var(--vendor-text)]">{title}</h2>
          {subtitle ? (
        ...
        {onAdd ? (
          <Button type="button" size="xs" onClick={onAdd} className="h-8 gap-1.5 px-3 text-[11px]">
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50 hover:bg-slate-50">
              ...
              <TableHead className="h-10 w-10 px-2 py-2 text-[11px] font-semibold text-slate-500">#</TableHead>
              <TableHead className="h-10 px-2 py-2 text-[11px] font-semibold text-slate-500">Preview</TableHead>
              <TableHead className="h-10 px-2 py-2 text-[11px] font-semibold text-slate-500">Title</TableHead>
              <TableHead className="h-10 px-2 py-2 text-[11px] font-semibold text-slate-500">Button</TableHead>
              <TableHead className="h-10 px-2 py-2 text-[11px] font-semibold text-slate-500">Status</TableHead>
              <TableHead className="h-10 px-2 py-2 text-right text-[11px] font-semibold text-slate-500">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {rows.map((row, index) => {
              ...
              >
                ...
                <TableCell className="w-10 px-2 py-3 text-[12px] font-semibold text-slate-600">{index + 1}</TableCell>
                ...
                <TableCell className="px-2 py-3 text-[12px] font-semibold text-slate-800 truncate max-w-[160px]">{row.title}</TableCell>
                <TableCell className="px-2 py-3 text-[12px] text-slate-600 truncate max-w-[100px]">{row.buttonLabel ?? "-"}</TableCell>
                <TableCell className="px-2 py-3">
                  <Switch
                    checked={row.enabled}
